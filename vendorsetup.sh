git clone -b 14.0 git@github.com:pixel-crdroid/proprietary_vendor_google_cheetah.git vendor/google/cheetah
git clone -b 14.0 git@github.com:pixel-crdroid/vendor_google_panther.git vendor/google/panther
git clone -b 14.0 git@github.com:pixel-crdroid/proprietary_vendor_google_lynx.git vendor/google/lynx
...
git clone git clone git@bitbucket.org:prototype2009/pixel_vendor_gapps.git vendor/gms
